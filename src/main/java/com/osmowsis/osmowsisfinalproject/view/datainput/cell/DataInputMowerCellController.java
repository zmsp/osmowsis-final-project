package com.osmowsis.osmowsisfinalproject.view.datainput.cell;
...
public class DataInputMowerCellController
{
    // FIELDS
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private static final String MOWER_NAME_PREFIX = "Mower";

    private static final int BATTERY_FULL_THRESHOLD = 75;
    private static final int BATTERY_THREE_QUARTERS_THRESHOLD = 50;
    private static final int BATTERY_HALF_THRESHOLD = 25;
    private static final int BATTERY_QUARTER_THRESHOLD = 0;
    ...
    {
        mowerName.setText(MOWER_NAME_PREFIX + " " + (mower.getMowerNumber() + 1));
    }
